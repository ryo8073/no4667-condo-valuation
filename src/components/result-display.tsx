...
export default function ResultDisplay({ result }: { result: ResultWithDetails | null }) {
  if (!result) {
    return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-blue-50 rounded-xl p-6 shadow-sm">
          ...
          <ul className="space-y-3 text-gray-900 text-base">
            ...
            <li className="font-bold text-lg text-blue-900 mt-3">評価額合計: <span className="font-mono">{formatNumber(result.totalSelf, 0)} 円</span></li>
          </ul>
        </div>
        <div className="bg-green-50 rounded-xl p-6 shadow-sm">
          ...
          <ul className="space-y-3 text-gray-900 text-base">
            ...
            <li className="font-bold text-lg text-green-900 mt-3">評価額合計: <span className="font-mono">{formatNumber(result.totalRental, 0)} 円</span></li>
          </ul>
        </div>
      </div>
